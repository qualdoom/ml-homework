...
class NeuralNetwork(nn.Module):
    def __init__(self, num_channels, height, width, n_actions):
        ...
        self.conv1 = nn.Conv2d(in_channels=num_channels, out_channels=4, kernel_size=(8, 8), stride=(1, 1))
        self.conv2 = nn.Conv2d(in_channels=4, out_channels=4, kernel_size=(8, 8), stride=(1, 1))
        self.conv3 = nn.Conv2d(in_channels=4, out_channels=4, kernel_size=(4, 4), stride=(1, 1))
